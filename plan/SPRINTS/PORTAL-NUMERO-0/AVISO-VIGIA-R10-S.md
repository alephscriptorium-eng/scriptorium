...
> rutas** publicadas y **conformidad de fusión**. Tag 
elease/numero-0
...
5. Autorización táctica para **sellado tag** 
elease/numero-0 **solo
...
- Tag 
elease/numero-0 = **post** R10-S OK + CHANGELOG (no ahora)
...
| tip main POST-push este aviso | $sha |
