...
| commits | `0354884032a6461d712b05cafa41fb8796b34880` (obra) · `dd5177e2cf7786b84f09aaba31367bf9bf52710b` (report SHA) |
...
```text
vitepress v1.6.4
build complete in 10.39s (worktree) / 7.21s (main post-merge)
build exit=0
...
**Aceptado ✅ (obra in-repo)** 2026-07-22 · merge `d4aff50`.
CA docs:build re-verificado en main (exit 0). **Residual DNS** (Pages
aleph-null + redirect scriptorium→pub) queda para tick custodio y
re-chequeo en **R4-S**. No se fingió C8 de dominios.
